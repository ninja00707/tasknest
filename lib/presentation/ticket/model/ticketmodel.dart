class TicketModel {
  ...
  TicketModel copyWith({
    ...
    String? priority,
    int? assignedDeptId,
    String? assignedDeptCode,
    String? assignedDeptName,
    String? createdByName,
    String? createdByDeptCode,
    int? createdByDeptId,
    int? createdById,
    int? assignedToId,
    String? assignedToName,
    int? myAssignedToId,
    String? myAssignedToName,
    int? reopenCount,
    String? lastAction,
    DateTime? lastUpdatedAt,
    String? lastActedByName,
    List<dynamic>? history,
    bool? isSubTicket,
    int? overallProgress,
    int? departmentCount,
    int? completedDepartmentCount,
    List<SubTicketDepartmentModel>? subDepartments,
    int? parentTicketId,
    String? ticketType,
    String? parentTicketTitle,
    String? parentTicketNumber,
    List<Map<String, dynamic>>? deptJourney,
    List<ChildTicketModel>? children,
    ...
    return TicketModel(
      ...
      assignedDeptId: assignedDeptId ?? this.assignedDeptId,
      assignedDeptCode: assignedDeptCode ?? this.assignedDeptCode,
      assignedDeptName: assignedDeptName ?? this.assignedDeptName,
      createdByName: createdByName ?? this.createdByName,
      createdByDeptCode: createdByDeptCode ?? this.createdByDeptCode,
      createdByDeptId: createdByDeptId ?? this.createdByDeptId,
      createdById: createdById ?? this.createdById,
      assignedToId: assignedToId ?? this.assignedToId,
      assignedToName: assignedToName ?? this.assignedToName,
      myAssignedToId: myAssignedToId ?? this.myAssignedToId,
      myAssignedToName: myAssignedToName ?? this.myAssignedToName,
      ...
      lastActedByName: lastActedByName ?? this.lastActedByName,
      history: history ?? this.history,
      isSubTicket: isSubTicket ?? this.isSubTicket,
      overallProgress: overallProgress ?? this.overallProgress,
      departmentCount: departmentCount ?? this.departmentCount,
      completedDepartmentCount: completedDepartmentCount ?? this.completedDepartmentCount,
      subDepartments: subDepartments ?? this.subDepartments,
      parentTicketId: parentTicketId ?? this.parentTicketId,
      ticketType: ticketType ?? this.ticketType,
      parentTicketTitle: parentTicketTitle ?? this.parentTicketTitle,
      parentTicketNumber: parentTicketNumber ?? this.parentTicketNumber,
      deptJourney: deptJourney ?? this.deptJourney,
      children: children ?? this.children,
      immediateChildCount: immediateChildCount ?? this.immediateChildCount,
      hasActiveChildren: hasActiveChildren ?? this.hasActiveChildren,
