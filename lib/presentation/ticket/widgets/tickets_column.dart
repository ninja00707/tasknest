...
class KanbanColumn extends StatelessWidget {
  ...
  /// NEW — wire these to your DashboardBloc:
  /// - hasMore: whether more pages exist for this status
  /// - isLoadingMore: show a small spinner at the bottom while fetching
  /// - onLoadMore: fires `LoadMoreTicketsForStatus(status)` on the bloc
  final bool hasMore;
            ...
            child: tickets.isEmpty
                ...
                : Padding(
                    ...
                    child: NotificationListener<ScrollNotification>(
                      // Fires onLoadMore once we're within 200px of the bottom
                      // of THIS column's own scroll — not the whole board.
